        ...
        <TooltipProvider key="play">
            <Tooltip>
                <TooltipTrigger className="fixed top-3 right-5">
                    <div className="p-2 rounded-lg bg-amber-500 cursor-pointer flex gap-2 text-white text-lg font-semibold">
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-7.5 h-7.5" viewBox="0 0 512 512" version="1.1">
                            <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                <g id="drop" className="fill-white" transform="translate(42.666667, 78.641067)">
                        ...
                        <div className="mt-0.5 font-bold">10K</div>
                    </div>
                </TooltipTrigger>
